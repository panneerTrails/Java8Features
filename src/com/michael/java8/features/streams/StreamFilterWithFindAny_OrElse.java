...
public class StreamFilterWithFindAny_OrElse {
	...
	public void displayResults(){
		...
		List<Integer> intList = Arrays.asList(3, 2, 1, 4, 5);
		...
		if(result8.isPresent()){
			System.out.println("result8 - parallel with findFirst :" + result8.get());
		}
	}
	...
	public static void main(String[] args) {
       ...
       Person result1 = persons.stream()                        // Convert to steam
		...
		StreamFilterWithFindAny_OrElse streamFilterWithFindAny_OrElse = new StreamFilterWithFindAny_OrElse();
		int size = 10;
		for(int i=0;i<size;i++){
			System.out.println();
			System.out.println("The iteration number : " + i);
			streamFilterWithFindAny_OrElse.displayResults();			
		}
