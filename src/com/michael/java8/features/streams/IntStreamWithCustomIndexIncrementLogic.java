...
public class IntStreamWithCustomIndexIncrementLogic {
	...
	public void displayTheRange(){
		int row = 0;
		int maxLimit = 121;
		//IntStream.iterate(row, i -> i+40).limit(maxLimit).forEach(System.out::println);
